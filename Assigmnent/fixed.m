...
% Last Modified by GUIDE v2.5 08-May-2019 23:30:26
...
cal = Fixed_point(equation);
 ...
 hold on;
 [yl,w,i,t] = cal.solve(handles,str2double(interval),round(str2double(numOfiteration)),str2double(epslion),"Fixed");
 set(handles.edit5,'string',sprintf('%f',yl));

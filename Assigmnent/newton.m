function varargout = newton(varargin)
    ...
    % Last Modified by GUIDE v2.5 08-May-2019 23:36:02
...
function pushbutton1_Callback(hObject, eventdata, handles)
    ...
    initial = get(handles.edit2, 'String');
    ...
    [y,w,i,t] = cal.solve(handles,equation,str2double(epslion),round(str2double(numOfiteration)),"Newton");
